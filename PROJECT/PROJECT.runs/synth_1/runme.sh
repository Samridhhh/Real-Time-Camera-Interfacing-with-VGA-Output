...
HD_PWD='C:/Users/samridh/PROJECT/PROJECT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OV7670_top_verilog.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OV7670_top_verilog.tcl
